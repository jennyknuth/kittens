...
class KittensControllerTest < ActionController::TestCase
  ...
  test "should create kitten" do
    assert_difference('Kitten.count') do
      post :create, kitten: { age: @kitten.age, cute: @kitten.cute, favorite_toy: @kitten.favorite_toy, name: @kitten.name }
    end
  ...
  test "should update kitten" do
    patch :update, id: @kitten, kitten: { age: @kitten.age, cute: @kitten.cute, favorite_toy: @kitten.favorite_toy, name: @kitten.name }
    assert_redirected_to kitten_path(assigns(:kitten))
  end
